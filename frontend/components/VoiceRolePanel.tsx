...
export function VoiceRolePanel({ activeRole }: VoiceRolePanelProps) {
  return (
    <div className="rounded-[22px] border border-stone-300/80 bg-[#fffaf2]/90 p-5 shadow-[0_12px_30px_rgba(70,52,34,0.06)] dark:border-espresso-700/70 dark:bg-espresso-900/90 dark:shadow-[0_12px_30px_rgba(28,22,18,0.35)]">
      <div className="mb-3 text-sm font-medium text-stone-700 dark:text-espresso-100">Voice focus</div>
            ...
            <motion.div
              ...
              className={`flex items-center gap-3 rounded-2xl border px-4 py-3 transition ${
                isActive
                  ...
                  : "border-stone-200 bg-white/80 dark:border-espresso-700 dark:bg-espresso-950"
              }`}
            >
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-stone-900 text-stone-50 dark:bg-cream dark:text-espresso-900">
